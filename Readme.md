...
чтобы открыть браузер в режиме с откл безоп : google-chrome --user-data-dir="~/chrome-dev-disabled-security" --disable-web-security --disable-site-isolation-trials